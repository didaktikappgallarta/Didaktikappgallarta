package com.example.didaktikapp.features.gameplay;
...
import  com.example.didaktikapp.WordSearchApp;
import  com.example.didaktikapp.commons.DurationFormatter;
import  com.example.didaktikapp.commons.Util;
import  com.example.didaktikapp.custom.LetterBoard;
import  com.example.didaktikapp.custom.StreakView;
import  com.example.didaktikapp.custom.layout.FlowLayout;
import  com.example.didaktikapp.features.FullscreenActivity;
import  com.example.didaktikapp.features.SoundPlayer;
import  com.example.didaktikapp.features.ViewModelFactory;
import  com.example.didaktikapp.model.GameData;
import  com.example.didaktikapp.model.UsedWord;
...
public class GamePlayActivity extends FullscreenActivity {
    ...
    public static final String EXTRA_GAME_ROUND_ID =
            " com.example.didaktikapp.features.gameplay.GamePlayActivity.ID";
    public static final String EXTRA_ROW_COUNT =
            " com.example.didaktikapp.features.gameplay.GamePlayActivity.ROW";
    public static final String EXTRA_COL_COUNT =
            " com.example.didaktikapp.features.gameplay.GamePlayActivity.COL";
    ...
    @BindColor(R.color.black) int mGrayColor;
    ...
    private void setContentView(int activity_game_play) {
    }
